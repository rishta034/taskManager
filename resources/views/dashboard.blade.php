...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/images/task.png') }}" type="image/x-icon">
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="task-section">
                ...
                <div class="empty-state">
                    <img src="{{ asset('assets/images/task2.png') }}" height="100px" />
                    <h3>No tasks yet</h3>
    ...
    <div class="modal" id="taskModal">
        <div class="modal-content">
            <div class="modal-header">
                 <img src="{{ asset('assets/images/task3.png') }}" height="50px" />
